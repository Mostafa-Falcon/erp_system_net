...
export function PurchaseReturnForm({
  ...
  const addLine = () => {
    setLines((prev) => [...prev, { productId: '', unitId: '', conversionFactor: 1, qty: '1', cost: '0' }]);
    setFormError('');
  };
      ...
      <div className="bg-white dark:bg-[#131b2e] rounded-2xl border border-slate-200/80 dark:border-slate-800 p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div>
            ...
            <select value={supplierId} onChange={(e) => setSupplierId(e.target.value)} className={selectCls + ' w-full'}>

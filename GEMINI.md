...
نظام **Falcon ERP** هو نظام إدارة تجارة وتجزئة ومخازن متقدم وشامل لكافة الأنشطة التجارية، مبني وفق معمارية **Offline-First** لضمان استمرارية العمل في نقاط البيع (POS) وإدارة المخازن والفواتير بكفاءة عالية وبشكل مستقل عن انقطاع الإنترنت، مع مزامنة سحابية لحظية وثنائية الاتجاه مع Supabase.
...
- **Supabase Database Token:** `sbp_v0_397d77fcae369aeee93ac5ffcd87f526c8770edd` (يُستخدم للربط والمزامنة مع قاعدة البيانات السحابية).
